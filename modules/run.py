...
class MAIN:
    ...
    def snap(self):
        ...
        reads = self.SINGLE if self.SINGLE else f'{self.LEFT} {self.RIGHT}'
        params = '-b' if self.SINGLE else '-b -s 0 1000 -H 300000 -M -mcp 10000000'
        snap_cmd        = ['snap-aligner', f'{mode}', self.SNAPINDEX, f'{reads}', '-o', self.BAM, '-h', '2000', '-d', '30', '-t', f'{self.THREADS}', f'{params}', '-D', '5', '-om', '5', '-omax', '10']
